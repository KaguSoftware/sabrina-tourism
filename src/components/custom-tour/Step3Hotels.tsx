  ...
  return (
    <div>
      ...
      <p className="text-ink-soft text-[15px] leading-[1.6] mb-10 max-w-[52ch]">
        Select your preferred hotel for each area in your itinerary. Our concierge team will confirm availability and arrange the booking.
      </p>
