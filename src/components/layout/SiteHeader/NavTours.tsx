...
export function NavTours({ currentPath }: NavToursProps) {
          ...
          <div className="flex flex-col divide-y divide-rule">
            {TOUR_ITEMS.map((item) => (
              ...
              >
                ...
                {/* arrow */}
                <svg
                  className="mt-1 shrink-0 text-ink/20 group-hover:text-ochre transition-colors duration-150 translate-x-0 group-hover:translate-x-0.5 transition-transform"
                  width="14"
                  height="14"
                  viewBox="0 0 24 24"
                  fill="none"
