...
export async function WhatsAppFAB() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-55 bg-ochre text-navy w-14 h-14 rounded-full flex items-center justify-center shadow-lg hover:bg-gold transition-colors duration-300 md:hidden"
    >
