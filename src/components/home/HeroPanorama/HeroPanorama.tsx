...
{/* Content */}
      ...
      <div aria-hidden="true" className="hidden sm:block absolute right-[-140px] bottom-[-140px] z-[1]">
      ...
      <div aria-hidden="true" className="hidden sm:block deco-hatch" style={{ top: 0, right: 0, width: 320, height: 320, color: "rgba(27,77,92,0.06)", zIndex: 1 }} />
      {/* Diagonal hatch — bottom left */}
      <div aria-hidden="true" className="hidden sm:block deco-hatch" style={{ bottom: 0, left: 0, width: 260, height: 260, color: "rgba(201,154,63,0.06)", zIndex: 1 }} />
      {/* Rings — top left (smaller accent) */}
      <div aria-hidden="true" className="hidden sm:block absolute left-[-80px] top-[-80px] z-[1]">
