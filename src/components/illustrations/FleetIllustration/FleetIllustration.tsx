...
function SedanSVG() {
  return (
    <>
      ...
      {/* Roof */}
      <path d="M60 40 Q68 26 100 24 Q132 26 140 40Z" fill="#7a8a4e" />
      {/* Windows */}
      ...
      {/* Wheels */}
      <circle cx="62" cy="82" r="16" fill="#8B9A5B" />
      <circle cx="62" cy="82" r="10" fill="#2a3a50" />
      <circle cx="62" cy="82" r="4" fill="#c99a3f" />
      <circle cx="138" cy="82" r="16" fill="#8B9A5B" />
...
function SUVSVG() {
  return (
    <>
      ...
      {/* Roof */}
      <path d="M58 34 Q64 22 100 20 Q136 22 142 34Z" fill="#7a8a4e" />
      {/* Windows */}
      ...
      {/* Wheels — bigger */}
      <circle cx="58" cy="84" r="18" fill="#8B9A5B" />
      <circle cx="58" cy="84" r="11" fill="#2a3a50" />
      <circle cx="58" cy="84" r="4.5" fill="#c99a3f" />
      <circle cx="142" cy="84" r="18" fill="#8B9A5B" />
...
function VanSVG() {
  return (
    <>
      ...
      {/* Rear doors */}
      <line x1="165" y1="30" x2="165" y2="85" stroke="#7a8a4e" strokeWidth="2" />
      {/* Wheels */}
      <circle cx="50" cy="87" r="17" fill="#8B9A5B" />
      <circle cx="50" cy="87" r="10" fill="#2a3a50" />
      <circle cx="50" cy="87" r="4" fill="#c99a3f" />
      <circle cx="150" cy="87" r="17" fill="#8B9A5B" />
...
function LuxurySVG() {
  return (
    <>
      {/* Long low body */}
      <path d="M18 80 L18 60 Q22 44 55 40 L145 40 Q178 44 182 60 L182 80Z" fill="#8B9A5B" />
      {/* Sweeping roof */}
      <path d="M55 40 Q65 28 100 26 Q135 28 145 40Z" fill="#7a8a4e" />
      {/* Windows */}
      <path d="M60 40 Q68 32 100 30 Q132 32 140 40Z" fill="#a8c8e1" opacity="0.5" />
      <line x1="100" y1="30" x2="100" y2="40" stroke="#8B9A5B" strokeWidth="1.5" />
      {/* Gold trim lines */}
      ...
      <ellipse cx="100" cy="98" rx="82" ry="4" fill="#8B9A5B" opacity="0.25" />
    </>
  );
}
