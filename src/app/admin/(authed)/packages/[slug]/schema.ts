...
export const PackageSchema = z.object({
  ...
  duration_days: z.number("Duration in days is required").int().min(1, "Duration must be at least 1 day"),
  ...
  min_people: z.number("Min people is required").int().min(1, "Min people must be at least 1"),
  max_people: z.number("Max people is required").int().min(1, "Max people must be at least 1"),
