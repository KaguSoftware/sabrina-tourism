...
export const DAILY_PACKAGES: DailyPackage[] = [
  {
    ...
    included: [
      { text: "Private Mercedes-Benz V-Class with professional driver", icon: null },
      { text: "Licensed English-speaking guide", icon: null },
      { text: "All entrance fees", icon: null },
      { text: "Sunset Bosphorus cruise tickets", icon: null },
      { text: "Dinner reservation", icon: null },
      { text: "Bottled water throughout the day", icon: null },
    ],
    notIncluded: [],
    season: null,
    pricing: null,
  },
  {
    ...
    included: [
      { text: "Private Toyota Land Cruiser with professional driver", icon: null },
      { text: "Licensed English-speaking guide", icon: null },
      { text: "All entrance fees (museum + underground city)", icon: null },
      { text: "Pottery workshop session", icon: null },
      { text: "Lunch and dinner", icon: null },
      { text: "Bottled water throughout the day", icon: null },
    ],
    notIncluded: [],
    season: null,
  ...
  },
  {
    ...
    cardImage: "/Antalya_Alternative1.png",
    groupImages: [
    ...
    included: [
      { text: "Private Mercedes-Benz Sprinter with professional driver", icon: null },
      { text: "Licensed English-speaking guide", icon: null },
      { text: "All entrance fees", icon: null },
      { text: "Riverside lunch and harbour dinner", icon: null },
      { text: "Bottled water throughout the day", icon: null },
    ],
    notIncluded: [],
    season: null,
