...
export function registerFonts() {
  ...
  registered = true;
  // bump this comment to force re-registration after font changes: v3
  ...
  // Fraunces — display serif (Latin locales)
  Font.register({
    family: "Fraunces",
    fonts: [
  ...
  // Inter — body sans (Latin) — include weight 300 and italic fallbacks for use as display fallback
  Font.register({
    family: "Inter",
    fonts: [
      { src: path.join(it, "inter-latin-400-normal.woff"), fontWeight: 300, fontStyle: "normal" },
      { src: path.join(it, "inter-latin-400-normal.woff"), fontWeight: 300, fontStyle: "italic" },
      { src: path.join(it, "inter-latin-400-normal.woff"), fontWeight: 400, fontStyle: "normal" },
      { src: path.join(it, "inter-latin-400-normal.woff"), fontWeight: 400, fontStyle: "italic" },
      { src: path.join(it, "inter-latin-500-normal.woff"), fontWeight: 500, fontStyle: "normal" },
      { src: path.join(it, "inter-latin-500-normal.woff"), fontWeight: 500, fontStyle: "italic" },
      { src: path.join(it, "inter-latin-600-normal.woff"), fontWeight: 600, fontStyle: "normal" },
      { src: path.join(it, "inter-latin-600-normal.woff"), fontWeight: 600, fontStyle: "italic" },
      { src: path.join(it, "inter-latin-600-normal.woff"), fontWeight: 700, fontStyle: "normal" },
      { src: path.join(it, "inter-latin-600-normal.woff"), fontWeight: 700, fontStyle: "italic" },
      { src: path.join(it, "inter-latin-600-normal.woff"), fontWeight: 900, fontStyle: "normal" },
      { src: path.join(it, "inter-latin-600-normal.woff"), fontWeight: 900, fontStyle: "italic" },
    ],
  });
